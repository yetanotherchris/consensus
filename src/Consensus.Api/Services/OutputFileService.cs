...
public class OutputFileService : IOutputFileService
{
    ...
    public OutputFileService(string outputDirectory, ILogger<OutputFileService> logger)
    {
    ...
    {
        return Path.Combine(_outputDirectory, "output", "responses", $"output-{runId}.html");
    }

    private string GetMarkdownFilePath(string runId)
    {
        return Path.Combine(_outputDirectory, "output", "responses", $"consensus-{runId}.md");
    }
}
